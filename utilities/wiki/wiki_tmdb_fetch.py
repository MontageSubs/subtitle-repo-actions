...
SECTION_ALIASES = {
    "plot": {
        "en": ("Plot", "Synopsis", "Summary", "Premise", "Overview"),
        "zh": ("劇情", "剧情", "劇情簡介", "剧情简介", "劇情大綱", "故事大綱", "故事簡介", "故事简介", "情節", "情节", "內容概要", "内容概要", "內容簡介", "内容简介"),
        "fr": ("Synopsis", "Résumé", "Intrigue", "Argument"),
        "de": ("Handlung", "Inhalt", "Zusammenfassung"),
        "es": ("Argumento", "Trama", "Antecedentes", "Sinopsis", "Resumen"),
        "ja": ("あらすじ", "ストーリー", "概要", "内容"),
        "ko": ("줄거리", "내용", "요약"),
        "it": ("Trama", "Sinossi"),
        "pt": ("Enredo", "Sinopse", "Resumo"),
        "ru": ("Сюжет", "Содержание"),
        "tr": ("Konu", "Konusu", "Özet"),
        "fa": ("خلاصه داستان", "داستان", "خلاصه"),
        "ar": ("الحبكة", "القصة", "نبذة", "ملخص"),
        "th": ("เนื้อเรื่อง", "เรื่องย่อ"),
        "hi": ("कथानक", "कहानी", "सारांश"),
        "vi": ("Nội dung", "Cốt truyện", "Tóm tắt"),
        "id": ("Alur cerita", "Sinopsis", "Ringkasan"),
        "he": ("עלילה", "תקציר"),
        "el": ("Υπόθεση", "Σύνοψη"),
        "ro": ("Intrigă", "Subiect", "Rezumat"),
        "pl": ("Fabuła", "Streszczenie"),
        "cs": ("Děj", "Obsah"),
        "hu": ("Cselekmény", "Tartalom"),
        "uk": ("Сюжет", "Зміст"),
        "sv": ("Handling", "Sammanfattning"),
        "no": ("Handling", "Sammendrag"),
        "da": ("Handling", "Handlingsreferat"),
        "fi": ("Juoni", "Sisältö"),
        "nl": ("Verhaal", "Plot", "Inhoud"),
        "ms": ("Plot", "Jalan cerita", "Sinopsis"),
        "bn": ("কাহিনী", "সারাংশ"),
        "ta": ("கதைச்சுருக்கம்", "சுருக்கம்"),
    },
    "cast": {
        "en": ("Cast", "Characters", "Voice cast"),
        "zh": ("演員", "演员", "演員表", "演员表", "配音", "角色", "主要演員", "主要演员", "配音演員", "配音演员"),
        "fr": ("Distribution", "Personnages"),
        "de": ("Besetzung", "Figuren", "Rollen"),
        "es": ("Reparto", "Personajes"),
        "ja": ("キャスト", "出演者", "登場人物"),
        "ko": ("출연진", "등장인물"),
        "it": ("Cast", "Personaggi"),
        "pt": ("Elenco", "Personagens"),
        "ru": ("В ролях", "Персонажи"),
        "tr": ("Oyuncular", "Karakterler"),
        "fa": ("بازیگران", "شخصیت‌ها"),
        "ar": ("طاقم التمثيل", "الممثلون", "الشخصيات"),
        "th": ("นักแสดง", "ตัวละคร"),
        "hi": ("मुख्य कलाकार", "कलाकार", "पात्र"),
        "vi": ("Diễn viên", "Nhân vật"),
        "id": ("Pemeran", "Karakter"),
        "he": ("שחקנים", "דמויות"),
        "el": ("Πρωταγωνιστές", "Ηθοποιοί", "Χαρακτήρες"),
        "ro": ("Distribuție", "Personaje"),
        "pl": ("Obsada", "Postacie"),
        "cs": ("Obsazení", "Postavy"),
        "hu": ("Szereplők",),
        "uk": ("У ролях", "Персонажі"),
        "sv": ("Rollista", "Medverkande", "Roller"),
        "no": ("Medvirkende", "Rollebesetning", "Roller"),
        "da": ("Medvirkende", "Roller"),
        "fi": ("Näyttelijät", "Hahmot"),
        "nl": ("Rolverdeling", "Personages"),
        "ms": ("Pelakon", "Watak"),
        "bn": ("অভিনয়ে", "চরিত্র"),
        "ta": ("நடிகர்கள்", "கதாபாத்திரங்கள்"),
    },
    "reception": {
        "en": ("Reception", "Critical reception", "Reviews"),
        "zh": ("反響", "反响", "迴響", "回响", "評價", "评价", "評論", "评论", "反應", "反应"),
        "fr": ("Accueil", "Réception", "Accueil critique", "Critique", "Critiques"),
        "de": ("Rezeption", "Kritik", "Kritiken"),
        "es": ("Recepción", "Crítica", "Críticas"),
        "ja": ("評価", "反響", "批評"),
        "ko": ("평가", "비평"),
        "it": ("Accoglienza", "Critica", "Recensioni"),
        "pt": ("Recepção", "Crítica", "Críticas"),
        "ru": ("Реакция", "Восприятие", "Критика", "Отзывы"),
        "tr": ("Alım", "Eleştiriler", "Eleştiri"),
        "fa": ("بازتاب", "استقبال", "نقد"),
        "ar": ("الاستقبال", "نقد", "آراء النقاد"),
        "th": ("การตอบรับ", "คำวิจารณ์"),
        "hi": ("स्वागत", "समीक्षा"),
        "vi": ("Đón nhận", "Đánh giá"),
        "id": ("Penerimaan", "Tanggapan", "Ulasan"),
        "he": ("קבלה", "ביקורות"),
        "el": ("Υποδοχή", "Κριτικές"),
        "ro": ("Receptare", "Primire", "Recenzii"),
        "pl": ("Odbiór", "Recenzje"),
        "cs": ("Přijetí", "Recenze"),
        "hu": ("Fogadtatás", "Kritikák"),
        "uk": ("Сприйняття", "Критика"),
        "sv": ("Mottagande", "Kritik"),
        "no": ("Mottakelse", "Kritikk"),
        "da": ("Modtagelse", "Anmeldelser"),
        "fi": ("Vastaanotto", "Arvostelut"),
        "nl": ("Ontvangst", "Recensies", "Kritiek"),
        "ms": ("Sambutan", "Ulasan"),
        "bn": ("সমাদর", "প্রতিক্রিয়া", "সমালোচনা"),
        "ta": ("வரவேற்பு", "விமர்சனம்"),
    },
}
...
FUZZY_KEYWORDS = {
    "plot": {
        "en": ("plot", "synopsis", "summary", "premise", "overview"),
        "zh": ("剧情", "劇情", "故事", "大綱", "大纲", "情節", "情节", "概要", "简介", "簡介"),
        "fr": ("synopsis", "intrigue", "résumé", "argument"),
        "de": ("handlung", "zusammenfassung"),
        "es": ("argumento", "trama", "antecedentes", "sinopsis", "resumen"),
        "ja": ("あらすじ", "ストーリー", "概要", "内容"),
        "ko": ("줄거리", "내용", "요약"),
        "it": ("trama", "sinossi"),
        ...
        "tr": ("konu", "özet"),
        "fa": ("داستان", "خلاصه"),
        "ar": ("حبكة", "قصة", "نبذة", "ملخص"),
        "th": ("เนื้อเรื่อง", "เรื่องย่อ"),
        "hi": ("कथानक", "कहानी", "सारांश"),
        "vi": ("nội dung", "cốt truyện", "tóm tắt"),
        "id": ("alur cerita", "sinopsis", "plot", "ringkasan"),
        "he": ("עלילה", "תקציר"),
        "el": ("υπόθεση", "σύνοψη"),
        "ro": ("intrigă", "subiect", "rezumat"),
        "pl": ("fabuła", "streszczenie"),
    ...
    "reception": {
        "en": ("reception", "reviews", "critics"),
        "zh": ("反响", "反響", "回响", "迴響", "评价", "評價", "评论", "評論", "反应", "反應"),
        "fr": ("accueil", "réception", "critique"),
        "de": ("rezeption", "kritik"),
        "es": ("recepción", "crítica"),
        "ja": ("評価", "反響", "批評"),
        "ko": ("평가", "비평"),
        "it": ("accoglienza", "critica", "recensioni"),
        "pt": ("recepção", "crítica"),
