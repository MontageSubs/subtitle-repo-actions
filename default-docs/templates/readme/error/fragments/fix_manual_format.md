...
2. **重命名**：前往 **[Settings](../../settings)** --> **Repository name**，将仓库名改为 `英文片名_年份` 格式（如 `Backrooms_2026`）并保存。
...
2. **Rename**: Go to **[Settings](../../settings)** --> **Repository name**, rename it to the `EnglishTitle_Year` format (e.g. `Backrooms_2026`) and save.
